...
class user(models.Model):
    ...
    sex = models.IntegerField(choices=((0, '男'), (1, '女')), default="男", null=False, blank=False)
...
class meeting(models.Model):
    ...
    creat_person = models.ForeignKey(user, on_delete=models.SET_NULL, related_name = 'creat_person', null=True, blank=True, verbose_name="管理员")
